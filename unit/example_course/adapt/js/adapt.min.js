...
define('extensions/adapt-lmw5-article-complete/js/index',['coreJS/adapt'], function(Adapt) {
  Adapt.on('articleView:postRender', function(view) {
    if(view.model.attributes._isComplete) {
      window.parent.postMessage('lmw5ArticleComplete', '*');
    }
...
define('extensions/adapt-lmw5-article-navigate/js/index',['coreJS/adapt'], function(Adapt) {
  window.addEventListener('message', function(event) {
    if(event.data.message === "lmw5LoadArticle" && event.data.stage) {
      var articleId = Adapt.articles.models[event.data.stage - 1].attributes._id;
      var newHash = `#/id/${articleId}`;
      var newLocation = window.location.pathname + newHash;
...
define('theme/5dbc1bffe99c5f251dd472df/js/vanilla',['require','coreJS/adapt','backbone','theme/adapt-contrib-vanilla/js/theme-block'],function(require) {
...
;
define("plugins", ["components/adapt-contrib-graphic/js/adapt-contrib-graphic","components/adapt-contrib-media/js/adapt-contrib-media","components/adapt-contrib-narrative/js/adapt-contrib-narrative","components/adapt-contrib-text/js/adapt-contrib-text","extensions/adapt-contrib-assessment/js/adapt-assessmentArticleExtension","extensions/adapt-contrib-bookmarking/js/adapt-contrib-bookmarking","extensions/adapt-contrib-pageLevelProgress/js/adapt-contrib-pageLevelProgress","extensions/adapt-contrib-spoor/js/adapt-contrib-spoor","extensions/adapt-contrib-trickle/js/adapt-contrib-trickle","extensions/adapt-contrib-tutor/js/adapt-contrib-tutor","extensions/adapt-lmw-mobileFixes/js/adapt-lmw-mobileFixes","extensions/adapt-lmw-publishing/js/adapt-lmw-publishing","extensions/adapt-lmw-speech/js/adapt-lmw-speech","extensions/adapt-lmw5-article-complete/js/index","extensions/adapt-lmw5-article-navigate/js/index","menu/adapt-contrib-boxMenu/js/adapt-contrib-boxmenu","theme/5dbc1bffe99c5f251dd472df/js/vanilla"], function(){});
